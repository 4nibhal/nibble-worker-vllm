...
```bash
docker build -t username/image:tag --build-arg VLLM_NIGHTLY=true --build-arg VLLM_NIGHTLY_VERSION=0.16.1rc1.dev275+ga708ef594 --build-arg TRANSFORMERS_REF=421c7f6248e28d24d84ee000252a1e71fbc24917 .
```
